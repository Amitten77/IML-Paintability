...
public:
     ...
     * Time complexity: O(nk).
     */
    Board(size_t n, size_t k, std::vector<std::vector<int>> boardState);
     ...
     * Time complexity: O(nk).
     */
    Board(size_t n, size_t k, std::vector<std::vector<int>> boardState, std::vector<std::vector<bool>> chipIsMoved);
    ...
    [[nodiscard]] const std::vector<std::vector<int>>& getBoardState() const noexcept;
...
private:
     ...
     */
    std::vector<std::vector<int>> boardState_;
